<?php  //[STAMP] 8817f3fbcd0323faed6662f25588d804
...
trait WebGuyActions
{
    ...
    public function checkAllBoxes($selector) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('checkAllBoxes', func_get_args()));
    }
    ...
    public function getElementsCount($selector) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getElementsCount', func_get_args()));
    }
     ...
     *
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Acceptance::seeInCurrentAbsoluteUrl()
     */
    public function canSeeInCurrentAbsoluteUrl($text) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeInCurrentAbsoluteUrl', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function apiCheckDomainExists($domain) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('apiCheckDomainExists', func_get_args()));
    }
    ...
    public function apiCheckDomainNotExists($domain) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('apiCheckDomainNotExists', func_get_args()));
    }
    ...
    public function apiGetDomainRoutes($domain) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('apiGetDomainRoutes', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\SpampanelApi::apiGetDomainAliases()
     */
    public function apiGetDomainAliases($domain) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('apiGetDomainAliases', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\SpampanelApi::makeSpampanelApiRequest()
     */
     ...
     *
     *
     * @see \Helper\SpampanelApi::requestUrl()
     */
    public function requestUrl($url, $username = null, $password = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('requestUrl', func_get_args()));
    }
