    ...
    final static public function getContent($url, $config = null, $password = null, $rawData = null)
    {
        ...
        try {
            ...
            try {
                ...
                /** @var SpamFilter_PanelSupport_Plesk $panel */
            ...
            } /** @noinspection PhpUndefinedClassInspection */ catch (Zend_Uri_Exception $e) {
            ...
            $logger->debug('[HTTP] The HTTP request has failed, reason given:' . $e->getMessage());
